...
//    TODO: add End to End testing to the app
    ...
    val intent:Intent = Intent(getApplicationContext(), AuthenticationActivity::class.java)
    intent.putExtra("testing",true)
    val activityScenario = ActivityScenario.launch<AuthenticationActivity>(intent)
